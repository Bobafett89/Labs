...
let coinSpeed = 1; // general coin speed
let coinPosition = {
	x: 350,
	y: 400
};
...
function setup()
{
	...
	coinDirection = random(0, 360); // random direction in an angle
	coinAxisSpeed = {
		x: coinSpeed * cos(coinDirection*PI/180),
		y: coinSpeed * sin(coinDirection*PI/180)
	}; // speed for coin on x and y axis
}
